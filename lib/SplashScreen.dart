...
class _SplashScreenState extends State<SplashScreen> {
  ...
  getLastViewedPage() async {
    ...
    if (prefs.containsKey(globals.LAST_VIEWED_PAGE)) {
      var lastViewedPage = prefs.getInt(globals.LAST_VIEWED_PAGE);
      setState(() {
        globals.lastViewedPage = lastViewedPage!;
      });
    }
  }
  ...
  getBrightnessLevel() async {
    ...
    if (prefs.containsKey(globals.BRIGHTNESS_LEVEL)) {
      var brightnessLevel = prefs.getDouble(globals.BRIGHTNESS_LEVEL);
      setState(() {
        globals.brightnessLevel = brightnessLevel!;
      });
    } else {
